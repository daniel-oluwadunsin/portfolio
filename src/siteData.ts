...
export const contactLinks: SiteLink[] = [
  ...
  { label: 'CV', href: 'https://drive.google.com/file/d/1jWYP0PiHnFT5o2YDjKKi6lUpbud2yPQq/view?usp=sharing' },
  { label: 'GitHub', href: githubUrl },
  { label: 'LinkedIn', href: 'https://www.linkedin.com/in/daniel-adejare-551a20237/' },
...
export const projects: Project[] = [
  {
    ...
    technology: 'React, Vite, Express, PostgreSQL/PostGIS, Gemini, Cloudinary, Geoapify, and Graphile Worker',
    links: [{ label: 'Live site', href: civicPulseUrl }],
  },
  {
    name: 'Black Lightning',
    description:
      'A research-driven music-recognition system that identifies songs from short microphone recordings. It normalizes audio, extracts spectral peaks with FFTs, creates compact fingerprints, and uses offset-aware voting to find the most consistent match in a fingerprint database.',
    technology: 'Next.js, Express, Prisma, PostgreSQL, BullMQ, Redis, and FFmpeg',
    links: [
      { label: 'Live site', href: 'https://black-ligthning.oluwadunsin.dev/' },
      { label: 'Source code', href: 'https://github.com/daniel-oluwadunsin/black-ligthning' },
    ],
  },
  {
    name: 'Recourse',
    ...
    links: [
      ...
      { label: 'Source code', href: 'https://github.com/daniel-oluwadunsin/recourse' },
    ],
  },
]
...
export const newsItems: NewsItem[] = [
  {
    ...
    content: [
      { text: 'Won the ' },
      { text: 'AI3 Growth Hackathon', href: 'https://luma.com/3s90t09i?tk=QSeBeQ' },
      { text: ' by ' },
  ...
  },
  {
    ...
    links: [{ label: 'Appointment photo', href: 'https://pbs.twimg.com/media/Gaoy9EDXUAAsiwB?format=jpg&name=4096x4096' }],
  },
  {
    date: 'March 2025',
    content: [
  ...
  },
  {
    ...
    links: [{ label: 'HackOps report', href: 'https://pipeops.io/hackops-report' }],
  },
]
...
export const blogPosts: BlogPost[] = [
  {
    ...
    excerpt: 'A practical account of designing reversible operations for transactional file systems.',
  ...
  },
  {
    ...
    date: '2025',
    readTime: 'Read on Medium',
    excerpt: 'What a successful HTTP response can hide when payment state is treated too simply.',
